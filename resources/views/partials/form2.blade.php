<form class="w-full max-w-2xl animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-200" method="POST" action="{{route('analyze')}}">
        @csrf
        <div class="relative">
          @error('keyword')
          ...
          <div class="flex gap-2">
            <div class="relative flex-1">
              ...
              >
                ...
                class="flex w-full border-input bg-background px-3 py-2 ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium 
                file:text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 
                disabled:cursor-not-allowed disabled:opacity-50 md:text-sm 
                pl-12 {{--h-14--}} py-2 text-lg rounded-xl border-2 focus:border-primary transition-all"
            ...
            <button
              ...
              {{--h-14--}} px-4 md:px-8 py-2 rounded-xl {{--text-lg--}} shadow-lg shadow-primary/20 hover:shadow-xl hover:shadow-primary/30 transition-all"
              type="submit"
            >
